...
type CLI struct {
	...
	Send     GmailSendCmd     `cmd:"" name:"send" hidden:"" help:"Send an email (alias for 'gmail send')"`
	Ls       DriveLsCmd       `cmd:"" name:"ls" aliases:"list" hidden:"" help:"List Drive files (alias for 'drive ls')"`
	Search   DriveSearchCmd   `cmd:"" name:"search" aliases:"find" hidden:"" help:"Search Drive files (alias for 'drive search')"`
	Open     OpenCmd          `cmd:"" name:"open" aliases:"browse" hidden:"" help:"Print a best-effort web URL for a Google URL/ID (offline)"`
	Download DriveDownloadCmd `cmd:"" name:"download" aliases:"dl" hidden:"" help:"Download a Drive file (alias for 'drive download')"`
	Upload   DriveUploadCmd   `cmd:"" name:"upload" aliases:"up,put" hidden:"" help:"Upload a file to Drive (alias for 'drive upload')"`
	Login    AuthAddCmd       `cmd:"" name:"login" hidden:"" help:"Authorize and store a refresh token (alias for 'auth add')"`
	Logout   AuthRemoveCmd    `cmd:"" name:"logout" hidden:"" help:"Remove a stored refresh token (alias for 'auth remove')"`
	Status   AuthStatusCmd    `cmd:"" name:"status" aliases:"st" hidden:"" help:"Show auth/config status (alias for 'auth status')"`
	Me       PeopleMeCmd      `cmd:"" name:"me" hidden:"" help:"Show your profile (alias for 'people me')"`
	Whoami   PeopleMeCmd      `cmd:"" name:"whoami" aliases:"who-am-i" hidden:"" help:"Show your profile (alias for 'people me')"`

	Auth       AuthCmd               `cmd:"" hidden:"" help:"Auth and credentials"`
	Groups     GroupsCmd             `cmd:"" aliases:"group" hidden:"" help:"Google Groups"`
	...
	Calendar   CalendarCmd           `cmd:"" aliases:"cal" hidden:"" help:"Google Calendar"`
	Classroom  ClassroomCmd          `cmd:"" aliases:"class" hidden:"" help:"Google Classroom"`
	Time       TimeCmd               `cmd:"" hidden:"" help:"Local time utilities"`
	Gmail      GmailCmd              `cmd:"" aliases:"mail,email" hidden:"" help:"Gmail"`
	Chat       ChatCmd               `cmd:"" hidden:"" help:"Google Chat"`
	Contacts   ContactsCmd           `cmd:"" aliases:"contact" hidden:"" help:"Google Contacts"`
	Tasks      TasksCmd              `cmd:"" aliases:"task" hidden:"" help:"Google Tasks"`
	People     PeopleCmd             `cmd:"" aliases:"person" hidden:"" help:"Google People"`
	Keep       KeepCmd               `cmd:"" hidden:"" help:"Google Keep (Workspace only)"`
	Sheets     SheetsCmd             `cmd:"" aliases:"sheet" help:"Google Sheets"`
	Forms      FormsCmd              `cmd:"" aliases:"form" hidden:"" help:"Google Forms"`
	AppScript  AppScriptCmd          `cmd:"" name:"appscript" aliases:"script,apps-script" hidden:"" help:"Google Apps Script"`
	Config     ConfigCmd             `cmd:"" hidden:"" help:"Manage configuration"`
	ExitCodes  AgentExitCodesCmd     `cmd:"" name:"exit-codes" aliases:"exitcodes" hidden:"" help:"Print stable exit codes (alias for 'agent exit-codes')"`
	Agent      AgentCmd              `cmd:"" hidden:"" help:"Agent-friendly helpers"`
	Schema     SchemaCmd             `cmd:"" hidden:"" help:"Machine-readable command/flag schema" aliases:"help-json,helpjson"`
	VersionCmd VersionCmd            `cmd:"" name:"version" hidden:"" help:"Print version"`
	Completion CompletionCmd         `cmd:"" hidden:"" help:"Generate shell completion scripts"`
...
func baseDescription() string {
	return "Google CLI for Drive/Docs/Sheets/Slides"
}
