...
type SlidesCmd struct {
	...
	CreateFromMarkdown SlidesCreateFromMarkdownCmd `cmd:"" name:"create-from-markdown" hidden:"" help:"Create a presentation from markdown (each slide starts with --- followed by ## Title)"`
	CreateFromJSON     SlidesCreateFromJSONCmd     `cmd:"" name:"create-from-json" help:"Create a presentation from a JSON specification file or inline JSON string.\n\nJSON spec schema:\n  {\"presentation\": {\n    \"title\": \"string\",\n    \"templateId\": \"optional Google Slides ID to copy from\",\n    \"slides\": [\n      {\n        \"layout\": \"TITLE_SLIDE|SECTION_HEADER|TITLE_AND_BODY|TITLE_AND_TWO_COLUMNS|TITLE_ONLY|ONE_COLUMN_TEXT|MAIN_POINT|SECTION_TITLE_AND_DESCRIPTION|CAPTION|BIG_NUMBER|BLANK\",\n        \"content\": {\n          \"PLACEHOLDER_KEY\": \"plain text or markdown (supports **bold** *italic* ~~strike~~ __underline__ [link](url))\",\n          \"PLACEHOLDER_KEY\": {\"type\": \"text\", \"text\": \"markdown string\"},\n          \"PLACEHOLDER_KEY\": {\"type\": \"table\", \"rows\": 3, \"columns\": 2, \"data\": [[\"a\",\"b\"],[\"c\",\"d\"],[\"e\",\"f\"]], \"headerRow\": true},\n          \"PLACEHOLDER_KEY\": {\"type\": \"image\", \"url\": \"https://...\"}\n        },\n        \"notes\": \"optional speaker notes (supports markdown)\",\n        \"customElements\": [\n          {\"type\": \"shape\", \"shapeType\": \"TEXT_BOX\", \"text\": \"hello\", \"position\": {\"x\": 100, \"y\": 200, \"unit\": \"PT\"}, \"size\": {\"width\": 300, \"height\": 50}, \"style\": {\"backgroundColor\": {\"rgb\": [255,0,0]}, \"textStyle\": {\"fontSize\": 14, \"bold\": true}}},\n          {\"type\": \"image\", \"url\": \"https://...\", \"position\": {\"x\": 0, \"y\": 0}, \"size\": {\"width\": 400, \"height\": 300}},\n          {\"type\": \"line\", \"lineCategory\": \"STRAIGHT|CURVED\", \"position\": {\"x\": 100, \"y\": 200}, \"size\": {\"width\": 300, \"height\": 0}, \"style\": {\"lineStyle\": {\"weight\": 2, \"endArrow\": \"OPEN_ARROW\"}}},\n          {\"type\": \"table\", \"rows\": 2, \"columns\": 3, \"data\": [[\"a\",\"b\",\"c\"]], \"headerRow\": true}\n        ]\n      }\n    ]\n  }}\n\nPlaceholder keys by layout:\n  TITLE_SLIDE: CENTERED_TITLE, SUBTITLE\n  SECTION_HEADER: TITLE\n  TITLE_AND_BODY: TITLE, BODY\n  TITLE_AND_TWO_COLUMNS: TITLE, BODY_0, BODY_1\n  TITLE_ONLY: TITLE\n  ONE_COLUMN_TEXT: TITLE, BODY\n  MAIN_POINT: TITLE\n  SECTION_TITLE_AND_DESCRIPTION: TITLE, SUBTITLE, BODY\n  CAPTION: BODY\n  BIG_NUMBER: TITLE, BODY\n  BLANK: (none, use customElements)"`
